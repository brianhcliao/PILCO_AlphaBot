%% draw_rollout_ab.m
% *Summary:* Script to draw the most recent trajectory of the AlphaBot
...
% means and covariances of the Cartesian coordinates of the AlphaBot
